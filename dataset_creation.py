...
create_few_shots(dataset_name='xnli',k=4,seeds=[32],set_up='sim_in_cross')#No Need to create 5 seeds as here demos will be same in all seeds (Nearest neighbor always same)
